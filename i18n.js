...
const i18n = {
  es: {
    ...
    'ep.mision.h2':'Misión',
    'ep.mision.p1':'Somos una empresa proveedora de inoculantes, bioestimulantes, coadyuvantes y otras especialidades para el agro, en constante crecimiento.',
    'ep.mision.p2':'Trabajamos con estrictos niveles de calidad, alta tecnología y rentabilidad; en armonía con el medio ambiente y enfocados en nuestros clientes.',
    'ep.mision.p3':'Somos nuestra gente.',
    'ep.vision.h2':'Visión',
    'ep.vision.p':'Nuestro marcado carácter innovador y constante esfuerzo en desarrollo será siempre uno de nuestros mayores activos y nos permitirá seguir penetrando en el mercado hasta afianzarnos como claros referentes. Fragaria será una empresa rentable, con fuerte liderazgo comercial, tecnológico y ambiental.',
    'ep.val.h2':'Nuestros Valores',
    'ep.val.v1.t':'INTEGRIDAD','ep.val.v1.d':'Nuestras conductas están siempre comprometidas con los valores morales. Las conductas y actitudes corporativas son coherentes con el comportamiento ético de las personas que la componen, siempre.',
    'ep.val.v2.t':'PASIÓN','ep.val.v2.d':'El entusiasmo y la creatividad, son la historia, presente y futuro del desarrollo de la empresa. La sinergia de su gente es el reaseguro del compromiso con el futuro.',
    'ep.val.v3.t':'CARÁCTER HUMANO','ep.val.v3.d':'Apoyamos e incentivamos todas las actividades y actitudes positivas de nuestra gente, sabiendo que esto es un factor estratégico para el crecimiento de la organización en todo sentido.',
  ...
  en: {
    ...
    'emp.item1.t':'Biological fertilizers','emp.item1.d':'Products to improve yield with lower environmental impact.',
    'emp.item2.t':'Adjuvants','emp.item2.d':'Application optimizers for greater effectiveness.',
    'emp.item3.t':'Agricultural specialties','emp.item3.d':'Development with a responsible environmental approach.',
    ...
    'ep.mision.p1':'We are a company providing inoculants, biostimulants, adjuvants and other agricultural specialties, in constant growth.',
    'ep.mision.p2':'We work with strict quality levels, high technology and profitability; in harmony with the environment and focused on our customers.',
    'ep.mision.p3':'We are our people.',
    'ep.vision.h2':'Vision',
    'ep.vision.p':'Our strong innovative character and constant development effort will always be one of our greatest assets and will allow us to continue penetrating the market until we establish ourselves as clear leaders. Fragaria will be a profitable company, with strong commercial, technological and environmental leadership.',
    'ep.val.h2':'Our Values',
    'ep.val.v1.t':'INTEGRITY','ep.val.v1.d':'Our behaviors are always committed to moral values. Corporate behaviors and attitudes are consistent with the ethical behavior of the people who compose it, always.',
    'ep.val.v2.t':'PASSION','ep.val.v2.d':'Enthusiasm and creativity are the history, present and future of the company\'s development. The synergy of its people is the guarantee of commitment to the future.',
    'ep.val.v3.t':'HUMAN CHARACTER','ep.val.v3.d':'We support and encourage all positive activities and attitudes of our people, knowing that this is a strategic factor for the growth of the organization in every sense.',
  ...
  pt: {
    ...
    'emp.item1.t':'Fertilizantes biológicos','emp.item1.d':'Produtos para melhorar o rendimento com menor impacto ambiental.',
    'emp.item2.t':'Coadjuvantes','emp.item2.d':'Otimizadores de aplicações para maior eficácia.',
    'emp.item3.t':'Especialidades agropecuárias','emp.item3.d':'Desenvolvimento com foco ambiental responsável.',
    ...
    'ep.mision.h2':'Missão',
    'ep.mision.p1':'Somos uma empresa provedora de inoculantes, bioestimulantes, coadjuvantes e outras especialidades para o agro, em constante crescimento.',
    'ep.mision.p2':'Trabalhamos com rigorosos níveis de qualidade, alta tecnologia e rentabilidade; em harmonia com o meio ambiente e focados em nossos clientes.',
    'ep.mision.p3':'Somos a nossa gente.',
    'ep.vision.h2':'Visão',
    'ep.vision.p':'Nosso marcado caráter inovador e constante esforço em desenvolvimento sempre será um de nossos maiores ativos e nos permitirá continuar penetrando no mercado até nos consolidarmos como referências claras. Fragaria será uma empresa rentável, com forte liderança comercial, tecnológica e ambiental.',
    'ep.val.h2':'Nossos Valores',
    'ep.val.v1.t':'INTEGRIDADE','ep.val.v1.d':'Nossas condutas estão sempre comprometidas com os valores morais. As condutas e atitudes corporativas são coerentes com o comportamento ético das pessoas que a compõem, sempre.',
    'ep.val.v2.t':'PAIXÃO','ep.val.v2.d':'O entusiasmo e a criatividade são a história, presente e futuro do desenvolvimento da empresa. A sinergia de seus colaboradores é o reaseguro do compromisso com o futuro.',
    'ep.val.v3.t':'CARÁTER HUMANO','ep.val.v3.d':'Apoiamos e incentivamos todas as atividades e atitudes positivas de nossa equipe, sabendo que isso é um fator estratégico para o crescimento da organização em todo sentido.',
  ...
  ru: {
    ...
    'emp.item1.t':'Биологические удобрения','emp.item1.d':'Продукты для улучшения урожайности с меньшим воздействием на окружающую среду.',
    'emp.item2.t':'Адъюванты','emp.item2.d':'Оптимизаторы применения для большей эффективности.',
    'emp.item3.t':'Сельскохозяйственные специальности','emp.item3.d':'Разработка с ответственным экологическим подходом.',
    ...
    'ep.mision.h2':'Миссия',
    'ep.mision.p1':'Мы являемся поставщиком инокулянтов, биостимуляторов, адъювантов и других сельскохозяйственных специальностей в постоянном росте.',
    'ep.mision.p2':'Мы работаем со строгими стандартами качества, высокими технологиями и рентабельностью; в гармонии с окружающей средой и с фокусом на наших клиентах.',
    'ep.mision.p3':'Мы — это наши люди.',
    'ep.vision.h2':'Видение',
    'ep.vision.p':'Наш выраженный инновационный характер и постоянные усилия в развитии всегда будут одним из наших главных активов и позволят нам продолжать проникать на рынок, пока мы не утвердимся как явные лидеры. Fragaria будет прибыльной компанией с сильным коммерческим, технологическим и экологическим лидерством.',
    'ep.val.h2':'Наши ценности',
    'ep.val.v1.t':'ЧЕСТНОСТЬ','ep.val.v1.d':'Наше поведение всегда подчиняется моральным ценностям. Корпоративное поведение и отношение соответствуют этическому поведению людей, которые её составляют, всегда.',
    'ep.val.v2.t':'СТРАСТЬ','ep.val.v2.d':'Энтузиазм и творчество — это история, настоящее и будущее развития компании. Синергия ее людей — это гарантия приверженности будущему.',
    'ep.val.v3.t':'ЧЕЛОВЕЧНОСТЬ','ep.val.v3.d':'Мы поддерживаем и поощряем все позитивные действия и установки наших людей, зная, что это стратегический фактор роста организации во всех смыслах.',
